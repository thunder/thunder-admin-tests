...
COMPOSER_MEMORY_LIMIT=-1 composer require drush/drush:~8.1 burdamagazinorg/image-derive-all:dev-drupl9 thunder/thunder_styleguide thunder/thunder_testing_demo:"${THUNDER_TESTING_DEMO_BRANCH}"-dev
