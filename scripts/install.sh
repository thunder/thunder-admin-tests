...
composer create-project burdamagazinorg/thunder-project:2.x ${HOME}/builds/test-dir --stability dev --no-interaction --no-install

cd ${HOME}/builds/test-dir
...
rm -rf ${HOME}/builds/test-dir/docroot/themes/contrib/thunder_admin
mv ${HOME}/builds/BurdaMagazinOrg/theme-thunder-admin ${HOME}/builds/test-dir/docroot/themes/contrib/thunder_admin
...
${HOME}/builds/test-dir/bin/drush site-install thunder --account-pass=admin --db-url=mysql://thunder:thunder@127.0.0.1/drupal install_configure_form.enable_update_status_module=NULL -y
