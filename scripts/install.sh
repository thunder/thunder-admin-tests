...
# Install thunder
${HOME}/build/test-dir/bin/drush site-install thunder --account-pass=admin --db-url="sqlite:${HOME}/build/test-dir/docroot/sites/default/files/.testbasesqlite" install_configure_form.enable_update_status_module=NULL thunder_module_configure_form.install_modules_thunder_demo -y
