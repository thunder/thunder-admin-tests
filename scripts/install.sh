...
COMPOSER_MEMORY_LIMIT=-1 composer require drush/drush:~8.1 burdamagazinorg/image-derive-all:master@dev thunder/thunder_styleguide:fix/thunder-demo-dependency-dev thunder/thunder_testing_demo:fix/add-help-module-dependency-dev
